    ...
    public partial class Home : Form
    {
        ...
        private void bunifuFlatButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlDataAdapter sda = new MySqlDataAdapter("select * from contractlist where model='" + comboBox1.Text + "' && type1='" + comboBox2.Text + "'", conn);
        ...
        {
            MySqlConnection conn = new MySqlConnection(@"datasource=127.0.0.1;port=3306;SslMode=none;username=root;password=;database=highlanderdb;");
            MySqlDataAdapter sda = new MySqlDataAdapter("select DISTINCT model from contractlist", conn);
            ...
            MySqlDataAdapter sda1 = new MySqlDataAdapter("select DISTINCT type1 from contractlist", conn);
            DataSet dt1 = new DataSet();
            sda1.Fill(dt1);

            comboBox2.DataSource = dt1.Tables[0];
            comboBox2.DisplayMember = "type1";
            comboBox2.ValueMember = "type1";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                if (int.Parse(textBox6.Text) >= int.Parse(textBox7.Text))
                {
                    ...
                    UpdateQuery += "update contractlist set crewamount='" + (int.Parse(textBox6.Text) - int.Parse(textBox7.Text)) + "' where id='" + textBox1.Text + "';";
